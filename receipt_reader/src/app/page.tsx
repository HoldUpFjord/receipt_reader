...
function downloadFile(content:string, filename:string, contentType:ContentType) {
...
export default function Home() {
  const handleDownload = () => {
    downloadFile('Hello, World!', 'hello.csv', 'text/csv');
  };

  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <MyButtonComponent onClick={handleProcess} />
